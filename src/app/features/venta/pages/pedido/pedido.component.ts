...
@Component({
  ...
  styles: [`
    ...
    .pedido-footer { position:fixed; bottom:0; left:0; right:0; background:#fff; border-top:1px solid #E2E6F0; padding:1rem; z-index:20; }
    ...
    <div class="page-content pedido-page pb-32" style="display:flex;flex-direction:column;gap:0.875rem">
      ...
      @if (carritoSvc.items().length === 0) {
        ...
        <div class="rv-section">
          <div style="display:flex;align-items:center;justify-content:space-between;padding:0.875rem 1rem;border-bottom:1px solid #E2E6F0">
            ...
            <div style="display:flex;align-items:center;gap:0.75rem">
              ...
              <a routerLink="/ventas/catalogo" style="font-size:0.75rem;font-weight:600;color:#1F2A7C;text-decoration:none;padding:0.3rem 0.75rem;border:1.5px solid #C7D2FE;border-radius:8px;background:#EEF2FF">+ Agregar</a>
            </div>
          </div>
